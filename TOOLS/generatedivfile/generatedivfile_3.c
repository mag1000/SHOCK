...
/////////////////////////////////////////////////////////////
	...
	char path[300];
	char zonename[32];
	sprintf(path,"3d_NACA0012_yMin40_500000_2048x256x256.sddc");
//	sprintf(zonename,"dom-2");
	sprintf(zonename,"blk-2");
	int len_zonename=5;
	int i_size_mesh=2048;
	int j_size_mesh=256;
	int k_size_mesh=256;
	...
	int i_points_connected=256;		// number of grid points which are connected downstream of trailing edge
