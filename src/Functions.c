...
//				Taylor-Green Vortex
				case 8:
					...
					w = 0.0;
					p = pnt_config->InitializeValues_p0 + pnt_config->InitializeValues_rho0*pnt_config->InitializeValues_u0*pnt_config->InitializeValues_u0/16*(cos(2*pnt_mesh->x[ijk])+cos(2*pnt_mesh->y[ijk]))*(cos(2*pnt_mesh->z[ijk])+2);
					rho=pnt_config->InitializeValues_rho0;
					break;
