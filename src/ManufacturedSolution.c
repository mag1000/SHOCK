		...
		struct strct_configuration * pnt_config)
{
	...
	if (pnt_config->ManufacturedSolution_case==1)
	{
		...
		else
		{
			//supersonic-NavierStokes
			rho_0=1.0L/rho_ref;		rho_x=0.15L/rho_ref;		rho_y=-0.1L/rho_ref;		rho_z=-0.12L/rho_ref;		a_rho_x=1.0L;		a_rho_y=0.5L;		a_rho_z=1.5L;
			u_0=800.0L/u_ref;		u_x=50.0L/u_ref;			u_y=-30.0L/u_ref;			u_z=-18.0L/u_ref;			a_u_x=0.75L;		a_u_y=0.6L;			a_u_z=0.5L;
			v_0=800.0L/u_ref;		v_x=-75.0L/u_ref;			v_y=40.0L/u_ref;			v_z=-30.0L/u_ref;			a_v_x=0.5L;			a_v_y=2.0L/3.0L;	a_v_z=1.25L;
			w_0=800.0L/u_ref;		w_x=15.0L/u_ref;			w_y=-25.0L/u_ref;			w_z=35.0L/u_ref;			a_w_x=0.2L;			a_w_y=0.8L		;	a_w_z=0.6L;
			p_0=100000.0L/p_ref;	p_x=0.2L*100000.0L/p_ref;	p_y=0.5L*100000.0L/p_ref;	p_z=-0.35L*100000.0L/p_ref;	a_p_x=2.0L/3.0L;	a_p_y=1.0L;			a_p_z=1.L/3.L;
		}
	}
	else
	{
		...
		else
		{
			//subsonic-NavierStokes
			rho_0=1.0L/rho_ref;		rho_x=0.15L/rho_ref;		rho_y=-0.1L/rho_ref;		rho_z=-0.12L/rho_ref;		a_rho_x=1.0L;		a_rho_y=0.5L;		a_rho_z=1.5L;
			u_0=70.0L/u_ref;		u_x=5.0L/u_ref;				u_y=-3.0L/u_ref;			u_z=-1.80L/u_ref;			a_u_x=1.5L;			a_u_y=0.6L;			a_u_z=0.5L;
			v_0=90.0L/u_ref;		v_x=-7.5L/u_ref;			v_y=4.0L/u_ref;				v_z=-3.00L/u_ref;			a_v_x=0.5L;			a_v_y=1.5L;			a_v_z=1.25L;
			w_0=80.0L/u_ref;		w_x=1.5L/u_ref;				w_y=-2.50L/u_ref;			w_z=3.5L/u_ref;				a_w_x=1.0L/3.0L;	a_w_y=1.5L;			a_w_z=1.0L;
			p_0=100000.0L/p_ref;	p_x=0.2L*100000.0L/p_ref;	p_y=0.5L*100000.0L/p_ref;	p_z=-0.35L*100000.0L/p_ref;	a_p_x=2.0L/3.0L;	a_p_y=1.0L;			a_p_z=1.L/5.L;
		}
	}
#endif
