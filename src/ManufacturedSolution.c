		...
		for (j=pnt_config->int_jStartReal; j <= pnt_config->int_jEndReal; j++)
		{
			for (k=pnt_config->int_kStartReal; k <= pnt_config->int_kEndReal; k++)
			{
				...
				else
				{
					...
					/*
					 * Die folgenden Gleichungen sind stark vereinfachte Gleichungen mit X^3,Y^3,Z^3 und kein sin,cos
					 */

					mass = (CoordX*CoordX)*u_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*3.0L+(CoordY*CoordY)*v_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*3.0L+(CoordZ*CoordZ)*w_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*3.0L+(CoordX*CoordX)*rho_x*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordY*CoordY)*rho_y*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*rho_z*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L;
					x_momentum = (CoordX*CoordX)*rho_x*pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*3.0L+(CoordX*CoordX)*Upsilon*p_x*3.0L-CoordX*Psi*mue*u_x*8.0L-CoordY*Psi*mue*u_y*6.0L-CoordZ*Psi*mue*u_z*6.0L+(CoordX*CoordX)*u_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*6.0L+(CoordY*CoordY)*v_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordZ*CoordZ)*w_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordY*CoordY)*u_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*u_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+(CoordY*CoordY)*rho_y*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*rho_z*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L;
					y_momentum = (CoordY*CoordY)*rho_y*pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*3.0L+(CoordY*CoordY)*Upsilon*p_y*3.0L-CoordX*Psi*mue*v_x*6.0L-CoordY*Psi*mue*v_y*8.0L-CoordZ*Psi*mue*v_z*6.0L+(CoordX*CoordX)*v_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordX*CoordX)*u_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordY*CoordY)*v_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*6.0L+(CoordZ*CoordZ)*w_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*v_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+(CoordX*CoordX)*rho_x*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*rho_z*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L;
					z_momentum = (CoordZ*CoordZ)*rho_z*pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*3.0L+(CoordZ*CoordZ)*Upsilon*p_z*3.0L-CoordX*Psi*mue*w_x*6.0L-CoordY*Psi*mue*w_y*6.0L-CoordZ*Psi*mue*w_z*8.0L+(CoordX*CoordX)*w_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordY*CoordY)*w_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordX*CoordX)*u_x*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+(CoordY*CoordY)*v_y*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+(CoordZ*CoordZ)*w_z*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*6.0L+(CoordX*CoordX)*rho_x*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+(CoordY*CoordY)*rho_y*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L;
					energy = ((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*((CoordX*CoordX)*u_x*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordX*CoordX)*v_x*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordX*CoordX)*w_x*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+((CoordX*CoordX)*Upsilon*p_x*3.0L)/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z))-((CoordX*CoordX)*Upsilon*rho_x*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z)*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,2.0L)*3.0L)/(gammaNumber-1.0L))+(CoordX*CoordX)*rho_x*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))*3.0L+(CoordX*CoordX)*Upsilon*p_x*3.0L)*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)+((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*((CoordY*CoordY)*u_y*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordY*CoordY)*v_y*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordY*CoordY)*w_y*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+((CoordY*CoordY)*Upsilon*p_y*3.0L)/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z))-((CoordY*CoordY)*Upsilon*rho_y*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z)*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,2.0L)*3.0L)/(gammaNumber-1.0L))+(CoordY*CoordY)*rho_y*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))*3.0L+(CoordY*CoordY)*Upsilon*p_y*3.0L)*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)+((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*((CoordZ*CoordZ)*u_z*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*3.0L+(CoordZ*CoordZ)*v_z*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*3.0L+(CoordZ*CoordZ)*w_z*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*3.0L+((CoordZ*CoordZ)*Upsilon*p_z*3.0L)/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z))-((CoordZ*CoordZ)*Upsilon*rho_z*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z)*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,2.0L)*3.0L)/(gammaNumber-1.0L))+(CoordZ*CoordZ)*rho_z*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))*3.0L+(CoordZ*CoordZ)*Upsilon*p_z*3.0L)*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)+(CoordX*CoordX)*u_x*((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))+Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))*3.0L+(CoordY*CoordY)*v_y*((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))+Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))*3.0L+(CoordZ*CoordZ)*w_z*((rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(pow(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z,2.0L)*(1.0L/2.0L)+pow(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z,2.0L)*(1.0L/2.0L)+pow(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z,2.0L)*(1.0L/2.0L)+(Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))/((gammaNumber-1.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)))+Upsilon*(p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z))*3.0L+(CoordY*CoordY)*Psi*mue*v_y*((CoordX*CoordX)*u_x*2.0L-(CoordY*CoordY)*v_y*4.0L+(CoordZ*CoordZ)*w_z*2.0L)*3.0L+(CoordZ*CoordZ)*Psi*mue*w_z*((CoordX*CoordX)*u_x*2.0L+(CoordY*CoordY)*v_y*2.0L-(CoordZ*CoordZ)*w_z*4.0L)*3.0L-CoordX*Psi*mue*u_x*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*8.0L-CoordY*Psi*mue*u_y*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*6.0L-CoordZ*Psi*mue*u_z*(u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z)*6.0L-CoordX*Psi*mue*v_x*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*6.0L-CoordY*Psi*mue*v_y*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*8.0L-CoordZ*Psi*mue*v_z*(v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z)*6.0L-CoordX*Psi*mue*w_x*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*6.0L-CoordY*Psi*mue*w_y*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*6.0L-CoordZ*Psi*mue*w_z*(w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z)*8.0L-(CoordY*CoordY)*Psi*mue*u_y*((CoordY*CoordY)*u_y*3.0L+(CoordX*CoordX)*v_x*3.0L)*3.0L-(CoordX*CoordX)*Psi*mue*v_x*((CoordY*CoordY)*u_y*3.0L+(CoordX*CoordX)*v_x*3.0L)*3.0L-(CoordZ*CoordZ)*Psi*mue*u_z*((CoordZ*CoordZ)*u_z*3.0L+(CoordX*CoordX)*w_x*3.0L)*3.0L-(CoordX*CoordX)*Psi*mue*w_x*((CoordZ*CoordZ)*u_z*3.0L+(CoordX*CoordX)*w_x*3.0L)*3.0L-(CoordZ*CoordZ)*Psi*mue*v_z*((CoordZ*CoordZ)*v_z*3.0L+(CoordY*CoordY)*w_y*3.0L)*3.0L-(CoordY*CoordY)*Psi*mue*w_y*((CoordZ*CoordZ)*v_z*3.0L+(CoordY*CoordY)*w_y*3.0L)*3.0L+(CoordX*CoordX)*Psi*mue*u_x*((CoordX*CoordX)*u_x*-4.0L+(CoordY*CoordY)*v_y*2.0L+(CoordZ*CoordZ)*w_z*2.0L)*3.0L-CoordX*Gamma*mue*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,3.0L)*(rho_0-(CoordX*CoordX*CoordX)*rho_x*2.0L+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z)*(p_0*rho_x-p_x*rho_0-(CoordY*CoordY*CoordY)*p_x*rho_y-(CoordZ*CoordZ*CoordZ)*p_x*rho_z+(CoordY*CoordY*CoordY)*p_y*rho_x+(CoordZ*CoordZ*CoordZ)*p_z*rho_x)*6.0L-CoordY*Gamma*mue*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,3.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x-(CoordY*CoordY*CoordY)*rho_y*2.0L+(CoordZ*CoordZ*CoordZ)*rho_z)*(p_0*rho_y-p_y*rho_0+(CoordX*CoordX*CoordX)*p_x*rho_y-(CoordX*CoordX*CoordX)*p_y*rho_x-(CoordZ*CoordZ*CoordZ)*p_y*rho_z+(CoordZ*CoordZ*CoordZ)*p_z*rho_y)*6.0L-CoordZ*Gamma*mue*1.0L/pow(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z,3.0L)*(rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y-(CoordZ*CoordZ*CoordZ)*rho_z*2.0L)*(p_0*rho_z-p_z*rho_0+(CoordX*CoordX*CoordX)*p_x*rho_z+(CoordY*CoordY*CoordY)*p_y*rho_z-(CoordX*CoordX*CoordX)*p_z*rho_x-(CoordY*CoordY*CoordY)*p_z*rho_y)*6.0L;
		...
		struct strct_configuration * pnt_config)
{
	...
	if(pnt_config->flag_Inviscid==1)
	{
		...
		p_0=100000.0L/p_ref;	p_x=0.2L*100000.0L/p_ref;	p_y=0.5L*100000.0L/p_ref;	p_z=-0.35L*100000.0L/p_ref;	a_p_x=2.0L;			a_p_y=1.0L;			a_p_z=1./3.;
	}
	else
	{
		//supersonic-NavierStokes
		...
		v_0=800.0L/u_ref;		v_x=-75.0L/u_ref;			v_y=40.0L/u_ref;			v_z=-30.0L/u_ref;			a_v_x=0.5L;			a_v_y=2.0L/3.0L;	a_v_z=1.25L;
		w_0=800.0L/u_ref;		w_x=15.0L/u_ref;			w_y=-25.0L/u_ref;			w_z=35.0L/u_ref;			a_w_x=1.0L/3.0L;	a_w_y=1.5L;			a_w_z=1.0L;
		p_0=100000.0L/p_ref;	p_x=0.2L*100000.0L/p_ref;	p_y=0.5L*100000.0L/p_ref;	p_z=-0.35L*100000.0L/p_ref;	a_p_x=2.0L/3.0L;	a_p_y=1.0L;			a_p_z=1./3.;
	}
#endif
		...
		int ijk)
{
	...
	pnt_U_lastStep->rho[ijk]=rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z;
	pnt_U_lastStep->u[ijk]=u_0+(CoordX*CoordX*CoordX)*u_x+(CoordY*CoordY*CoordY)*u_y+(CoordZ*CoordZ*CoordZ)*u_z;
	pnt_U_lastStep->v[ijk]=v_0+(CoordX*CoordX*CoordX)*v_x+(CoordY*CoordY*CoordY)*v_y+(CoordZ*CoordZ*CoordZ)*v_z;
	pnt_U_lastStep->w[ijk]=w_0+(CoordX*CoordX*CoordX)*w_x+(CoordY*CoordY*CoordY)*w_y+(CoordZ*CoordZ*CoordZ)*w_z;
	pnt_U_lastStep->p[ijk]=p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z;
		...
		int ijk)
{
	...
	rho=rho_0+(CoordX*CoordX*CoordX)*rho_x+(CoordY*CoordY*CoordY)*rho_y+(CoordZ*CoordZ*CoordZ)*rho_z;
		...
		int ijk)
{
	...
	pressure=p_0+(CoordX*CoordX*CoordX)*p_x+(CoordY*CoordY*CoordY)*p_y+(CoordZ*CoordZ*CoordZ)*p_z;
