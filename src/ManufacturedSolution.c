		...
		for (j=pnt_config->int_jStartReal; j <= pnt_config->int_jEndReal; j++)
		{
			for (k=pnt_config->int_kStartReal; k <= pnt_config->int_kEndReal; k++)
			{
				...
				else
				{
					...
					mass = CoordX*u_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*v_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordX*rho_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*rho_x*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0;
					x_momentum = CoordX*Upsilon*p_x*2.0-Psi*mue*u_x*(1.4E1/3.0)+CoordX*rho_x*pow(u_0+u_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0+CoordX*u_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*4.0+CoordY*v_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*u_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*rho_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0;
					y_momentum = CoordY*Upsilon*p_x*2.0-Psi*mue*v_x*(1.4E1/3.0)+CoordY*rho_x*pow(v_0+v_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0+CoordX*v_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordX*u_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*v_x*(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*4.0+CoordX*rho_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0;
					energy = (u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(CoordX*u_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordX*v_x*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0+(CoordX*Upsilon*p_x*2.0)/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0))-(CoordX*Upsilon*rho_x*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0)/(gammaNumber-1.0))+CoordX*rho_x*(pow(u_0+u_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+pow(v_0+v_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0)))*2.0+CoordX*Upsilon*p_x*2.0)+(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(CoordY*u_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*2.0+CoordY*v_x*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*2.0+(CoordY*Upsilon*p_x*2.0)/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0))-(CoordY*Upsilon*rho_x*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0)/(gammaNumber-1.0))+CoordY*rho_x*(pow(u_0+u_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+pow(v_0+v_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0)))*2.0+CoordY*Upsilon*p_x*2.0)+CoordX*u_x*((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(pow(u_0+u_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+pow(v_0+v_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0)))+Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))*2.0+CoordY*v_x*((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(pow(u_0+u_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+pow(v_0+v_x*(CoordX*CoordX+CoordY*CoordY),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))/((rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))*(gammaNumber-1.0)))+Upsilon*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY)))*2.0-Gamma*mue*((p_x*2.0)/(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))-rho_x*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0-(CoordX*CoordX)*p_x*rho_x*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*8.0+(CoordX*CoordX)*(rho_x*rho_x)*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),3.0)*8.0)-Gamma*mue*((p_x*2.0)/(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY))-rho_x*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*2.0-(CoordY*CoordY)*p_x*rho_x*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),2.0)*8.0+(CoordY*CoordY)*(rho_x*rho_x)*(p_0+p_x*(CoordX*CoordX+CoordY*CoordY))*1.0/pow(rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY),3.0)*8.0)-Psi*mue*u_x*(u_0+u_x*(CoordX*CoordX+CoordY*CoordY))*(1.4E1/3.0)-Psi*mue*v_x*(v_0+v_x*(CoordX*CoordX+CoordY*CoordY))*(1.4E1/3.0)-CoordY*Psi*mue*u_x*(CoordY*u_x*2.0+CoordX*v_x*2.0)*2.0-CoordX*Psi*mue*u_x*(CoordX*u_x*(8.0/3.0)-CoordY*v_x*(4.0/3.0))*2.0-CoordX*Psi*mue*v_x*(CoordY*u_x*2.0+CoordX*v_x*2.0)*2.0+CoordY*Psi*mue*v_x*(CoordX*u_x*(4.0/3.0)-CoordY*v_x*(8.0/3.0))*2.0;
		...
		int ijk)
{
	...
	pnt_U_lastStep->rho[ijk]=rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY);
	pnt_U_lastStep->u[ijk]=u_0+u_x*(CoordX*CoordX+CoordY*CoordY);
	pnt_U_lastStep->v[ijk]=v_0+v_x*(CoordX*CoordX+CoordY*CoordY);
	pnt_U_lastStep->p[ijk]=p_0+p_x*(CoordX*CoordX+CoordY*CoordY);
		...
		int ijk)
{
	...
	rho=rho_0+rho_x*(CoordX*CoordX+CoordY*CoordY);
		...
		int ijk)
{
	...
	pressure=p_0+p_x*(CoordX*CoordX+CoordY*CoordY);
