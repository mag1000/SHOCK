		...
		struct strct_Flux * pnt_Q)
{
	...
	long double CoordX,CoordY,Upsilon,Psi,Gamma,gammaNumber,mue;

#if MESHDIMENSIONS==3
	long double z_momentum;
	long double CoordZ;
	long double rho_z,a_rho_z;
	long double u_z,a_u_z;
	long double v_z,a_v_z;
	long double w_0,w_x,w_y,w_z,a_w_x,a_w_y,a_w_z;
	long double p_z,a_p_z;
...
/* Alle mit sinus
					mass = (MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))/L+(MY_PI_L*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L;
					x_momentum = (MY_PI_L*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0))/L+(MY_PI_L*Upsilon*a_p_x*p_x*cos((CoordX*MY_PI_L*a_p_x)/L))/L+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_x*a_u_x)*mue*u_x*sin((CoordX*MY_PI_L*a_u_x)/L)*(4.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_y*a_u_y)*mue*u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_z*a_u_z)*mue*u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)+(MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*2.0)/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_u_y*u_y*cos((CoordY*MY_PI_L*a_u_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_u_z*u_z*cos((CoordZ*MY_PI_L*a_u_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L;
					y_momentum = (MY_PI_L*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0))/L+(MY_PI_L*Upsilon*a_p_y*p_y*cos((CoordY*MY_PI_L*a_p_y)/L))/L+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_x*a_v_x)*mue*v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_y*a_v_y)*mue*v_y*sin((CoordY*MY_PI_L*a_v_y)/L)*(4.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_z*a_v_z)*mue*v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)+(MY_PI_L*a_v_x*v_x*cos((CoordX*MY_PI_L*a_v_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))*2.0)/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_v_z*v_z*cos((CoordZ*MY_PI_L*a_v_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L;
					z_momentum = (MY_PI_L*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0))/L+(MY_PI_L*Upsilon*a_p_z*p_z*cos((CoordZ*MY_PI_L*a_p_z)/L))/L+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_x*a_w_x)*mue*w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_y*a_w_y)*mue*w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_z*a_w_z)*mue*w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)*(4.0/3.0)+(MY_PI_L*a_w_x*w_x*cos((CoordX*MY_PI_L*a_w_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_w_y*w_y*cos((CoordY*MY_PI_L*a_w_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L))*2.0)/L+(MY_PI_L*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L;
					energy = ((rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*((MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_v_x*v_x*cos((CoordX*MY_PI_L*a_v_x)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_w_x*w_x*cos((CoordX*MY_PI_L*a_w_x)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*Upsilon*a_p_x*p_x*cos((CoordX*MY_PI_L*a_p_x)/L))/(L*(gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))-(MY_PI_L*Upsilon*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0))/(L*(gammaNumber-1.0)))+(MY_PI_L*a_rho_x*rho_x*cos((CoordX*MY_PI_L*a_rho_x)/L)*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))))/L+(MY_PI_L*Upsilon*a_p_x*p_x*cos((CoordX*MY_PI_L*a_p_x)/L))/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))+((rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*((MY_PI_L*a_u_y*u_y*cos((CoordY*MY_PI_L*a_u_y)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_w_y*w_y*cos((CoordY*MY_PI_L*a_w_y)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*Upsilon*a_p_y*p_y*cos((CoordY*MY_PI_L*a_p_y)/L))/(L*(gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))-(MY_PI_L*Upsilon*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0))/(L*(gammaNumber-1.0)))+(MY_PI_L*a_rho_y*rho_y*cos((CoordY*MY_PI_L*a_rho_y)/L)*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))))/L+(MY_PI_L*Upsilon*a_p_y*p_y*cos((CoordY*MY_PI_L*a_p_y)/L))/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))+((rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*((MY_PI_L*a_u_z*u_z*cos((CoordZ*MY_PI_L*a_u_z)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)))/L+(MY_PI_L*a_v_z*v_z*cos((CoordZ*MY_PI_L*a_v_z)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)))/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)))/L+(MY_PI_L*Upsilon*a_p_z*p_z*cos((CoordZ*MY_PI_L*a_p_z)/L))/(L*(gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))-(MY_PI_L*Upsilon*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0))/(L*(gammaNumber-1.0)))+(MY_PI_L*a_rho_z*rho_z*cos((CoordZ*MY_PI_L*a_rho_z)/L)*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)))))/L+(MY_PI_L*Upsilon*a_p_z*p_z*cos((CoordZ*MY_PI_L*a_p_z)/L))/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L))+Gamma*mue*((1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_p_x*a_p_x)*p_x*sin((CoordX*MY_PI_L*a_p_x)/L))/(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_x*a_rho_x)*(rho_x*rho_x)*pow(cos((CoordX*MY_PI_L*a_rho_x)/L),2.0)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),3.0)*2.0-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_x*a_rho_x)*rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*a_p_x*a_rho_x*p_x*rho_x*cos((CoordX*MY_PI_L*a_p_x)/L)*cos((CoordX*MY_PI_L*a_rho_x)/L)*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)*2.0)+Gamma*mue*((1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_p_y*a_p_y)*p_y*sin((CoordY*MY_PI_L*a_p_y)/L))/(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_y*a_rho_y)*(rho_y*rho_y)*pow(cos((CoordY*MY_PI_L*a_rho_y)/L),2.0)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),3.0)*2.0-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_y*a_rho_y)*rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*a_p_y*a_rho_y*p_y*rho_y*cos((CoordY*MY_PI_L*a_p_y)/L)*cos((CoordY*MY_PI_L*a_rho_y)/L)*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)*2.0)+Gamma*mue*((1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_p_z*a_p_z)*p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))/(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_z*a_rho_z)*(rho_z*rho_z)*pow(cos((CoordZ*MY_PI_L*a_rho_z)/L),2.0)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),3.0)*2.0-1.0/(L*L)*(MY_PI_L*MY_PI_L)*(a_rho_z*a_rho_z)*rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L)*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*a_p_z*a_rho_z*p_z*rho_z*cos((CoordZ*MY_PI_L*a_p_z)/L)*cos((CoordZ*MY_PI_L*a_rho_z)/L)*1.0/pow(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L),2.0)*2.0)+(MY_PI_L*a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))+(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))))))/L+(MY_PI_L*a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))+(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))))))/L+(MY_PI_L*a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L))+(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))*(pow(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L),2.0)*(1.0/2.0)+pow(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L),2.0)*(1.0/2.0)+pow(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L),2.0)*(1.0/2.0)+(Upsilon*(p_0+p_x*sin((CoordX*MY_PI_L*a_p_x)/L)+p_y*sin((CoordY*MY_PI_L*a_p_y)/L)+p_z*sin((CoordZ*MY_PI_L*a_p_z)/L)))/((gammaNumber-1.0)*(rho_0+rho_x*sin((CoordX*MY_PI_L*a_rho_x)/L)+rho_y*sin((CoordY*MY_PI_L*a_rho_y)/L)+rho_z*sin((CoordZ*MY_PI_L*a_rho_z)/L))))))/L-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_u_y*mue*u_y*cos((CoordY*MY_PI_L*a_u_y)/L)*(a_u_y*u_y*cos((CoordY*MY_PI_L*a_u_y)/L)+a_v_x*v_x*cos((CoordX*MY_PI_L*a_v_x)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_v_x*mue*v_x*cos((CoordX*MY_PI_L*a_v_x)/L)*(a_u_y*u_y*cos((CoordY*MY_PI_L*a_u_y)/L)+a_v_x*v_x*cos((CoordX*MY_PI_L*a_v_x)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_u_z*mue*u_z*cos((CoordZ*MY_PI_L*a_u_z)/L)*(a_u_z*u_z*cos((CoordZ*MY_PI_L*a_u_z)/L)+a_w_x*w_x*cos((CoordX*MY_PI_L*a_w_x)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_w_x*mue*w_x*cos((CoordX*MY_PI_L*a_w_x)/L)*(a_u_z*u_z*cos((CoordZ*MY_PI_L*a_u_z)/L)+a_w_x*w_x*cos((CoordX*MY_PI_L*a_w_x)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_v_z*mue*v_z*cos((CoordZ*MY_PI_L*a_v_z)/L)*(a_v_z*v_z*cos((CoordZ*MY_PI_L*a_v_z)/L)+a_w_y*w_y*cos((CoordY*MY_PI_L*a_w_y)/L))-1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_w_y*mue*w_y*cos((CoordY*MY_PI_L*a_w_y)/L)*(a_v_z*v_z*cos((CoordZ*MY_PI_L*a_v_z)/L)+a_w_y*w_y*cos((CoordY*MY_PI_L*a_w_y)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_x*a_u_x)*mue*u_x*sin((CoordX*MY_PI_L*a_u_x)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))*(4.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_y*a_u_y)*mue*u_y*sin((CoordY*MY_PI_L*a_u_y)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_u_z*a_u_z)*mue*u_z*sin((CoordZ*MY_PI_L*a_u_z)/L)*(u_0+u_x*sin((CoordX*MY_PI_L*a_u_x)/L)+u_y*sin((CoordY*MY_PI_L*a_u_y)/L)+u_z*sin((CoordZ*MY_PI_L*a_u_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_x*a_v_x)*mue*v_x*sin((CoordX*MY_PI_L*a_v_x)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_y*a_v_y)*mue*v_y*sin((CoordY*MY_PI_L*a_v_y)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))*(4.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_v_z*a_v_z)*mue*v_z*sin((CoordZ*MY_PI_L*a_v_z)/L)*(v_0+v_x*sin((CoordX*MY_PI_L*a_v_x)/L)+v_y*sin((CoordY*MY_PI_L*a_v_y)/L)+v_z*sin((CoordZ*MY_PI_L*a_v_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_x*a_w_x)*mue*w_x*sin((CoordX*MY_PI_L*a_w_x)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_y*a_w_y)*mue*w_y*sin((CoordY*MY_PI_L*a_w_y)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L))+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*(a_w_z*a_w_z)*mue*w_z*sin((CoordZ*MY_PI_L*a_w_z)/L)*(w_0+w_x*sin((CoordX*MY_PI_L*a_w_x)/L)+w_y*sin((CoordY*MY_PI_L*a_w_y)/L)+w_z*sin((CoordZ*MY_PI_L*a_w_z)/L))*(4.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_u_x*mue*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*(a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)*-2.0+a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)+a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L))*(2.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_v_y*mue*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*(a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)-a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)*2.0+a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L))*(2.0/3.0)+1.0/(L*L)*(MY_PI_L*MY_PI_L)*Psi*a_w_z*mue*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*(a_u_x*u_x*cos((CoordX*MY_PI_L*a_u_x)/L)+a_v_y*v_y*cos((CoordY*MY_PI_L*a_v_y)/L)-a_w_z*w_z*cos((CoordZ*MY_PI_L*a_w_z)/L)*2.0)*(2.0/3.0);

					if((pnt_mesh->x[ijk]==pnt_mesh->y[ijk])&&(pnt_mesh->y[ijk]==pnt_mesh->z[ijk])&&(i==4)&&(j==4)&&(k==4))
						printf("Nach Formel: mass:  %.10Le - x: %.10Le - y: %.10Le - z: %.10Le - energy: %.10Le\n",mass,x_momentum,y_momentum,z_momentum,energy);
*/
				}
	...
	for (i=pnt_config->int_iStartGhosts; i <= pnt_config->int_iEndGhosts; i++)
		{
			for (j=pnt_config->int_jStartGhosts; j <= pnt_config->int_jEndGhosts; j++)
			{
				...
				{
					ijk=i*pnt_config->int_jMeshPointsGhostCells*pnt_config->int_kMeshPointsGhostCells+j*pnt_config->int_kMeshPointsGhostCells+k;
					pnt_mesh->BC_Corrector_xiMomentum[ijk]=1.0L;
					pnt_mesh->BC_Corrector_etaMomentum[ijk]=1.0L;
					pnt_mesh->BC_Corrector_zetaMomentum[ijk]=1.0L;
		...
		struct strct_configuration * pnt_config)
{
	...
	if (pnt_config->ManufacturedSolution_case==1)
	{
		if(pnt_config->flag_Inviscid==1)
		{
			...
			v_0=800.0L/u_ref;			v_x=-75.0L/u_ref;			v_y=40.0L/u_ref;			a_v_x=0.5L;		a_v_y=2.0L/3.0L;
	...
	else // (pnt_config->ManufacturedSolution_case==0)
	{
		if(pnt_config->flag_Inviscid==1)
		{
			...
			v_0=90.0L/u_ref;			v_x=-15.0L/u_ref;			v_y=8.5L/u_ref;				a_v_x=0.5L;		a_v_y=2.0L/3.0L;
			p_0=100000.0L/p_ref;		p_x=0.2L*100000.0L/p_ref;	p_y=0.5L*100000.0L/p_ref;	a_p_x=2.0L;		a_p_y=1.0L;
		}
		else
		{
	...
	if (pnt_config->ManufacturedSolution_case==1)
	{
		if(pnt_config->flag_Inviscid==1)
		{
			...
			v_0=800.0L/u_ref;		v_x=-75.0L/u_ref;			v_y=40.0L/u_ref;			v_z=-30.0L/u_ref;			a_v_x=0.5L;			a_v_y=2.0L/3.0L;	a_v_z=1.25L;
...
/*
			...
			if (flag==0)
			{
				...
				p_y=0.0L;	a_p_y=0.0L; u_y=0.0L;	a_u_y=0.0L;
				w_y=0.0L;	a_w_y=0.0L; rho_y=0.0L;	a_rho_y=0.0L;
				v_0=0.0L;	v_x=0.0L;	v_y=0.0L;	v_z=0.0L;	a_v_x=0.0L;	a_v_y=0.0L;	a_v_z=0.0L;

				rho_0=1.0L/rho_ref;			rho_x=0.15L/rho_ref;		rho_z=-0.1L/rho_ref;		a_rho_x=1.0L;	a_rho_z=0.5L;
				u_0=800.0L/u_ref;			u_x=50.0L/u_ref;			u_z=-30.0L/u_ref;			a_u_x=1.5L;		a_u_z=0.6L;
				w_0=800.0L/u_ref;			w_x=-75.0L/u_ref;			w_z=40.0L/u_ref;			a_w_x=0.5L;		a_w_z=1.5L;
				p_0=100000.0L/p_ref;		p_x=0.2L*100000.0L/p_ref;	p_z=0.5L*100000.0L/p_ref;	a_p_x=2.0L/3.0L;a_p_z=1.0L;
			}

			rho_0=1.0L/rho_ref;		rho_x=0.15L/rho_ref;		rho_y=0.15L/rho_ref;		rho_z=0.15L/rho_ref;		a_rho_x=1.0L;		a_rho_y=1.0L;		a_rho_z=1.0L;
			u_0=800.0L/u_ref;		u_x=50.0L/u_ref;			u_y=50.0L/u_ref;			u_z=50.0L/u_ref;			a_u_x=1.5L;			a_u_y=1.5L;			a_u_z=1.5L;
			v_0=800.0L/u_ref;		v_x=50.0L/u_ref;			v_y=50.0L/u_ref;			v_z=50.0L/u_ref;			a_v_x=1.5L;			a_v_y=1.5L;			a_v_z=1.5L;
			w_0=800.0L/u_ref;		w_x=50.0L/u_ref;			w_y=50.0L/u_ref;			w_z=50.0L/u_ref;			a_w_x=1.5L;			a_w_y=1.5L;			a_w_z=1.5L;
			p_0=100000.0L/p_ref;	p_x=0.2L*100000.0L/p_ref;	p_y=0.2L*100000.0L/p_ref;	p_z=0.2L*100000.0L/p_ref;		a_p_x=1.0L;			a_p_y=1.0L;			a_p_z=1.0L;
*/
		}
	}
	else
	{
		...
		{
			//subsonic-Euler
			rho_0=1.0L/rho_ref;			rho_x=0.1L/rho_ref;			rho_y=0.15L/rho_ref;		rho_z=-0.12L/rho_ref;		a_rho_x=0.75L;		a_rho_y=1.0L;	a_rho_z=1.5L;
			u_0=70.0L/u_ref;			u_x=4.0L/u_ref;				u_y=-12.0L/u_ref;			u_z=-8.0L/u_ref;			a_u_x=5.0L/3.0L;	a_u_y=1.5L;		a_u_z=0.5L;
			v_0=90.0L/u_ref;			v_x=-20.0L/u_ref;			v_y=4.0L/u_ref;				v_z=-3.0L/u_ref;			a_v_x=1.5L;			a_v_y=1.0L;		a_v_z=1.25L;
			w_0=90.0L/u_ref;			w_x=-20.0L/u_ref;			w_y=4.0L/u_ref;				w_y=6.0L/u_ref;				a_w_x=1.5L;			a_w_y=1.0L;		a_w_z=1.5L;
			p_0=100000.0L/p_ref;		p_x=-0.3L*100000.0L/p_ref;	p_y=0.2L*100000.0L/p_ref;	p_y=-0.3L*100000.0L/p_ref;	a_p_x=1.0L;			a_p_y=1.25L;	a_p_z=1.L/3.L;
		}
		else
		{
			//subsonic-NavierStokes
...
/*
	pnt_U_lastStep->rho[ijk]=(rho_0+rho_x*sinl(a_rho_x*MY_PI_L*CoordX/L)+rho_y*sinl(a_rho_y*MY_PI_L*CoordY/L)+rho_z*sinl(a_rho_z*MY_PI_L*CoordZ/L));
	pnt_U_lastStep->u[ijk]=(u_0+u_x*sinl(a_u_x*MY_PI_L*CoordX/L)+u_y*sinl(a_u_y*MY_PI_L*CoordY/L)+u_z*sinl(a_u_z*MY_PI_L*CoordZ/L));
	pnt_U_lastStep->v[ijk]=(v_0+v_x*sinl(a_v_x*MY_PI_L*CoordX/L)+v_y*sinl(a_v_y*MY_PI_L*CoordY/L)+v_z*sinl(a_v_z*MY_PI_L*CoordZ/L));
	pnt_U_lastStep->w[ijk]=(w_0+w_x*sinl(a_w_x*MY_PI_L*CoordX/L)+w_y*sinl(a_w_y*MY_PI_L*CoordY/L)+w_z*sinl(a_w_z*MY_PI_L*CoordZ/L));
	pnt_U_lastStep->p[ijk]=(p_0+p_x*sinl(a_p_x*MY_PI_L*CoordX/L)+p_y*sinl(a_p_y*MY_PI_L*CoordY/L)+p_z*sinl(a_p_z*MY_PI_L*CoordZ/L));
*/

	pnt_U_lastStep->e[ijk]=(0.5L*((pnt_U_lastStep->u[ijk]*pnt_U_lastStep->u[ijk])+(pnt_U_lastStep->v[ijk]*pnt_U_lastStep->v[ijk])+(pnt_U_lastStep->w[ijk]*pnt_U_lastStep->w[ijk]))+
							pnt_U_lastStep->p[ijk]/pnt_U_lastStep->rho[ijk]/(pnt_config->gammaNumber-1.0L)*pnt_config->Upsilon);
	pnt_U_lastStep->T[ijk]=
			fabsl(pnt_U_lastStep->p[ijk]/pnt_U_lastStep->rho[ijk]);

	pnt_U_lastStep->c[ijk]=
			sqrtl(pnt_config->Upsilon*
			pnt_config->gammaNumber*pnt_U_lastStep->p[ijk]/pnt_U_lastStep->rho[ijk]);

	pnt_U_lastStep->mue[ijk]=1.0L;
}
		...
		int flag)
{
	...
	if(flag==0)
	{
		...
		//HIER KANN AUF PRESSURE ALS CONVERGENZ GEWECHSELT WERDEN (OBEN DANN AUSKOMMENTIEREN)
		//pnt_config->ManufacturedSolution_L2_Delta=fabsl(pnt_config->ManufacturedSolution_L2_last-all_L2_norm_pressure[0]);
		...
		/*if(pnt_config->MPI_rank==0){printf("SHOCK: L2_norm(rho):%.1L0e (delta:%.8Le)\n",
				all_L2_norm_rho[0],
				delta);}*/
...
////									pnt_U_lastStep,
////									ijk);
////							pnt_U_lastStep->rho[ijk]=fabsl(pnt_U_lastStep->rho[ijk]-rho_exact);
//
