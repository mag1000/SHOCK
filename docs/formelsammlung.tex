...
% &-
% C_{D,5}\left(u_{i+6}-u_{i-5} \right)+
% C_{D,6}\left(u_{i+7}-u_{i-6} \right)-
% C_{D,7}\left(u_{i+8}-u_{i-7} \right)+
% C_{D,8}\left(u_{i+9}-u_{i-8} \right)-
% C_{D,9}\left(u_{i+10}-u_{i-9} \right)\\
\\
...
% C_{D,5}&=\frac{110649}{75600}\ \ 
% C_{D,6}=-\frac{15351}{75600}\ \ 
% C_{D,7}=\frac{2649}{75600}\ \ 
% C_{D,8}=-\frac{351}{75600}\ \ 
% C_{D,9}=-\frac{3}{9450}
\end{align*}

\subsubsection{Gemischte Ableitung: $\frac{\partial}{\partial \xi} \left(A\frac{\partial u}{ \partial \eta}\right)$}
\begin{align*}
...
% &-
% C_{P,5}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+6,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-5,j} \right)+
% C_{P,6}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+7,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-6,j} \right)-
% C_{P,7}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+8,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-7,j} \right)+
% C_{P,8}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+9,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-8,j} \right)-
% C_{P,9}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+10,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-9,j} \right)\\
\\
\left. A\frac{\partial u}{\partial \eta}\right|_{i-\frac{1}{2},j}&=
...
% &-
% C_{P,5}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+5,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-6,j} \right)+
% C_{P,6}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+6,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-7,j} \right)-
% C_{P,7}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+7,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-8,j} \right)+
% C_{P,8}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+8,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-9,j} \right)-
% C_{P,9}\left(\left. A\frac{\partial u}{\partial \eta}\right|_{i+9,j}+\left. A\frac{\partial u}{\partial \eta}\right|_{i-10,j} \right)\\
\\
...
% &-
% C_{P,5}\left(u_{i,j+6}+u_{i,j-5} \right)+
% C_{P,6}\left(u_{i,j+7}+u_{i,j-6} \right)-
% C_{P,7}\left(u_{i,j+8}+u_{i,j-7} \right)+
% C_{P,8}\left(u_{i,j+9}+u_{i,j-8} \right)-
% C_{P,9}\left(u_{i,j+10}+u_{i,j-9} \right)\\
\\
u_{i,j-\frac{1}{2}}&=
...
% &-
% C_{P,5}\left(u_{i,j+5}+u_{i,j-6} \right)+
% C_{P,6}\left(u_{i,j+6}+u_{i,j-7} \right)-
% C_{P,7}\left(u_{i,j+7}+u_{i,j-8} \right)+
% C_{P,8}\left(u_{i,j+8}+u_{i,j-9} \right)-
% C_{P,9}\left(u_{i,j+9}+u_{i,j-10} \right)\\
\end{align*}
\begin{align*}
C_{P,0}&=\frac{1}{1260}\ \ 
C_{P,1}=-\frac{23}{2520}\ \ 
...
% C_{P,5}&=\frac{1627}{2520}\ \ 
% C_{P,6}=-\frac{473}{2520}\ \ 
% C_{P,7}=\frac{127}{2520}\ \ 
% C_{P,8}=-\frac{23}{2520}\ \ 
% C_{P,9}=\frac{1}{1260}
\end{align*}


\subsection{Approximation der konvektiven Flüsse inkl. Flux Vector Splitting}
